...
class Client(mqtt.Client):
    ...
    def do_on_connect(self, client, userdata, flags, rc):
        print("Connected with result code {0}".format(rc))
        self.subscribe(topic="/casa/AirQ", qos=2)
        print("Suscribed")
    ...
    def do_on_message(self, client, userdata, msg):
        ...
        if msg == 'temperatureDHT22':
          self.publish("/casa/AirQ/temperatureDHT22", temperature2)
        elif msg == 'humidity':
          self.publish("/casa/AirQ/humidity", humidity2)
        elif msg == 'temperature':
          self.publish("/casa/AirQ/temperature", temperature)
        elif msg == 'pressure':
          self.publish("/casa/AirQ/pressure", pressure)
...
def main():
  ...
  client = Client("AirQ", "192.168.0.162", "1883")
  client.connect()
  #client.loop_forever()
  client.loop_start()
  ...
  while True:
    ...
    temperature2,humidity2 = readDHT22(22,22)
    particulas = readParticulas()
    client.publish("/casa/AirQ/temperatureDHT22", temperature2)
    client.publish("/casa/AirQ/humidity", humidity2)
